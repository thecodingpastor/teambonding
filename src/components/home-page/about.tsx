...
const AboutSection = () => {
  return (
    <div className="flex flex-col md:flex-row gap-10 max-w-[500px] md:max-w-[1200px] px-4 mx-auto my-10 md:my-20">
      <Image
        src={LandingAbout}
        alt=""
        width={300}
        className="flex-1 shrink-0 rounded-xl"
        sizes="300vw"
      />
      <AnimatedInView
        x={20}
        opacity={0}
        className="flex-1 shrink-0 flex flex-col gap-6 md:gap-0 lg:pt-6 -order-1 md:order-1"
      >
